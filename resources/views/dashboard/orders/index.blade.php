...
{{--                                        <th>@lang('site.status')</th>--}}
                                    ...
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td>{{ number_format($order->totle_price, 2) }}</td>
                                            {{--<td>--}}
                                                {{--<button--}}
                                            ...
                                            <td>
                                                ...
                                                @if (auth()->user()->hasPermission('update_orders'))
                                                    <a href="{{ route('dashboard.client.orders.edit', ['client' => $order->client->id, 'order' => $order->id]) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> @lang('site.edit')</a>
                                                @else
